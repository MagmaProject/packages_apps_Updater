 ...
 */
package com.magma.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.magma.build.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.magma.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.magma.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "magma.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "magma.updater.uri";
